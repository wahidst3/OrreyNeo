...
const ThreeDBox = () => {
  ...
  useEffect(() => {
    ...
    // Create the Catalina-McNaught object mesh
    const catalinaGeometry = new THREE.SphereGeometry(0.1, 16, 16);
